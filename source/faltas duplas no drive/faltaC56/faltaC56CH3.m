...
% A simulação nesse script trata do disparo da 1ª à 3ª chave no IGBT C5 
% (CH1 à CH3) e dos disparos das demais no IGBT C6 (CH1-CH7).
...
cd 'faltas duplas no drive'/faltaC56
